 ...
 */ class TZDate extends _mini.TZDateMini {
    ...
    toLocaleString(locales, options) {
        return Date.prototype.toLocaleString.call(this, locales, _object_spread_props._(_object_spread._({}, options), {
            timeZone: (options === null || options === void 0 ? void 0 : options.timeZone) || this.timeZone
        }));
    }
    toLocaleDateString(locales, options) {
        return Date.prototype.toLocaleDateString.call(this, locales, _object_spread_props._(_object_spread._({}, options), {
            timeZone: (options === null || options === void 0 ? void 0 : options.timeZone) || this.timeZone
        }));
    }
    toLocaleTimeString(locales, options) {
        return Date.prototype.toLocaleTimeString.call(this, locales, _object_spread_props._(_object_spread._({}, options), {
            timeZone: (options === null || options === void 0 ? void 0 : options.timeZone) || this.timeZone
        }));
    }
    //#endregion
